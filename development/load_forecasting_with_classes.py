...
class Sarima_tuning(object):
    def __init__(self, freq, season, test_length):
        self.freq = freq
        self.season = season
    ...
    def fit_sarimaX(self, y, arima_params, s_params):
        '''
    ...
    def fit_sarima(self, y, arima_params, s_params):
        '''
        Fit a SARIMA model to data with given parameters
        -----------
        y: Pandas Series
    ...
    def cross_val_score(y, params, chunks, window=1):
        ...
        '''
        self.y = y
        self.arima_params = params[0]
        self.s_params = params[1]
        ...
        for i in xrange(chunks+1):
            ...
            results = self.rolling_predictions_sarima(y,end_index,window, params)
...
if __name__== '__main__':
    ...
    df = Data_preparation(p,f).get_data()
    # df = dp.get_data()
    y = df.create_variable(agg='sum',feature='power_all')
    cv_folds = 25
